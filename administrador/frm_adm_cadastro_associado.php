...
$ins_bl_associado->registerTrigger("END", "Trigger_Default_Redirect", 99, "frm_adm_cadastro_socios.php?associado={POST.ass_cnpj}&nro_socios={POST.ass_nro_socios}");
// Add columns
...
<div id="table">
  <table width="654" align="left" cellpadding="2" cellspacing="0" class="KT_topnav" id="button2">
    <tr>
      <td width="96" height="42" align="right" class="form_validation_field_error_container"><label for="ass_razao_social"><span class="letra">Razao Social</span>:</label></td>
      <td width="245"><input name="ass_razao_social" type="text" class="mxw_add" id="ass_razao_social" value="<?php echo KT_escapeAttribute($row_rsbl_associado['ass_razao_social']); ?>" size="35" />
      ...
      <td width="227"><input type="text" name="ass_nome_fantasia" id="ass_nome_fantasia" value="<?php echo KT_escapeAttribute($row_rsbl_associado['ass_nome_fantasia']); ?>" size="35" />
...
?>
    ...
    <tr>
      ...
      <td><input type="text" name="ass_ativ_principal" id="ass_ativ_principal" value="<?php echo KT_escapeAttribute($row_rsbl_associado['ass_ativ_principal']); ?>" size="35" />
        <?php echo $tNGs->displayFieldHint("ass_ativ_principal");?> <?php echo $tNGs->displayFieldError("bl_associado", "ass_ativ_principal"); ?></td>
      <td align="right" class="form_validation_field_error_container"><label for="ass_pessoa_contato">Nome Pessoa para Contato:</label></td>
    ...
    <tr>
      <td align="right" class="form_validation_field_error_container"><label for="ass_email_pessoa_contato">E-mail Pessoa pra Contato:</label></td>
      ...
      <td align="right" class="form_validation_field_error_container"><label for="ass_nome_admin_empresa">Nome do Administrador:</label></td>
    ...
    <tr>
      <td align="right" class="form_validation_field_error_container"><label for="ass_email_admin_empresa">E-mail do Administrador:</label></td>
      ...
      <td align="right" class="form_validation_field_error_container"><label for="ass_ci_admin_empresa">CI do Administrador:</label></td>
    ...
    <tr>
      <td align="right" class="form_validation_field_error_container"><label for="ass_cpf_admin_empresa">CPF do Administrador:</label></td>
      <td><span id="sprytextfield2">
     ...
     <td align="right" class="form_validation_field_error_container"><label for="ass_telefone_admin_empresa">Telefone do Administrador:</label></td>
      <td><input name="ass_telefone_admin_empresa" id="ass_telefone_admin_empresa" value="<?php echo KT_escapeAttribute($row_rsbl_associado['ass_telefone_admin_empresa']); ?>" size="35" wdg:subtype="MaskedInput" wdg:mask="(99)9999-9999" wdg:restricttomask="yes" wdg:type="widget" />
    ...
    <tr align="right" class="form_validation_field_error_container">
      <td height="51" colspan="4"><p>
        <center>
          <input name="KT_Insert1" type="submit" class="KT_tngtable" id="KT_Insert1" value="Enviar informa&ccedil;&otilde;es" />
        </center>
     </td>
    </tr>
  </table>
