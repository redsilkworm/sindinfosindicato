...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $insertGoTo = "frm_adm_cadastro_socios.php?associado=" . $row_rs_associado['ass_cnpj'] . "&nro_socios=" . $row_rs_associado['ass_nro_socios'] . "";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<p align="center" class="title2"><strong>Etapa 2/2</strong> - <strong>Cadastro de S&oacute;cios da Empresa</strong></p>
<p>&nbsp;</p>
<p></p>
...
<?php if ($totalRows_rs_associado > 0) { // Show if recordset not empty ?>
  ...
  <p><span class="outro">N&uacute;mero de S&oacute;cios:</span> <span class="letra"><?php echo $_GET['nro_socios'];?></span></p>
<?php } // Show if recordset not empty ?>
<p>&nbsp;</p>


<?php if ($totalRows_rs_socios < $_GET['nro_socios']) { // mostra formulario se nro socios cadastrados for menor que o declardo no formulário anterior ?>
...
<?php if ($totalRows_rs_socios > 0) { // Show if recordset not empty ?>
  <p align="center" class="title2"><strong>Rela&ccedil;&atilde;o de S&oacute;cios Cadastrados</strong></p>
  <table width="100%" border="1">
    ...
    <?php do { ?>
      <tr>
        ...
        <td><form id="form2" name="form2" method="post" action="frm_adm_deleta_socio.php?socio=<?php echo $row_rs_socios['soc_id']; ?>">
          <label>
  ...
  <p>&nbsp;</p>
  <form id="form3" name="form3" method="post" action="frm_adm_confirma_cadastro_associado.php?proposta=<?php echo $row_rs_associado['ass_id']; ?>">
    <label>
