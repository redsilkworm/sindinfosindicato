...
if ((isset($_GET['socio'])) && ($_GET['socio'] != "")) {
  ...
  $deleteGoTo = "frm_adm_cadastro_socios.php?associado=" . $row_rs_socio['ass_cnpj'] . "&nro_socios=" . $row_rs_socio['ass_nro_socios'] . "";
...
<body>
<span class="letra"><?php echo $row_rs_socio['soc_id']; ?></span> - <span class="letra"><?php echo $row_rs_socio['soc_nome']; ?></span>
</body>
</html>
<?php
