...
$upd_bl_associado->registerTrigger("END", "Trigger_Default_Redirect", 99, "frm_adm_revisao_cadastro_socios.php?associado={POST.ass_cnpj}&nro_socios={POST.ass_nro_socios}");
// Add columns
