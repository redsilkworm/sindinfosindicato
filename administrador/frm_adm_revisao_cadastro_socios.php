...
<?php if ($totalRows_rs_socios > 0) { // Show if recordset not empty ?>
  ...
  <table width="100%" border="1">
    ...
    <tr>
      ...
      <td><form id="form2" name="form2" method="post" action="../visitante/frm_revisao_deleta_socio.php?socio=<?php echo $row_rs_socios['soc_id']; ?>">
        <label>
...
<p>&nbsp;</p>
<?php if ($totalRows_rs_socios > 0) { // Show if recordset not empty ?>
  <form id="form3" name="form3" method="post" action="../visitante/frm_confirma_cadastro_associado.php?proposta=<?php echo $row_rs_associado['ass_id']; ?>">
    <label>
