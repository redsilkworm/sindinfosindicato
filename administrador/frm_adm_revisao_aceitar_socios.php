...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  $updateGoTo = "frm_adm_revisao_aceitar_associado.php?ass_id=" . $_POST['ass_id'] . "";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<body>
<p><span class="letra"><?php echo $row_rs_socio['ass_cnpj']; ?></span> - 
  <span class="letra"><?php echo $row_rs_socio['ass_razao_social']; ?></span> </p>
<p></p>
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table align="center">
    <tr valign="baseline">
      <td nowrap="nowrap" align="right"><span class="outra">Nome</span>:</td>
      <td><input type="text" name="soc_nome" value="<?php echo htmlentities($row_rs_socio['soc_nome'], ENT_COMPAT, 'iso-8859-2'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Telefone:</td>
      <td><input name="soc_telefone" id="soc_telefone" value="<?php echo htmlentities($row_rs_socio['soc_telefone'], ENT_COMPAT, 'iso-8859-2'); ?>" size="32" wdg:subtype="MaskedInput" wdg:mask="(99)9999-9999" wdg:restricttomask="yes" wdg:type="widget" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">E-mail:</td>
      <td><span id="sprytextfield1">
      <input type="text" name="soc_email" value="<?php echo htmlentities($row_rs_socio['soc_email'], ENT_COMPAT, 'iso-8859-2'); ?>" size="32" />
    ...
    <tr valign="baseline">
      ...
      <td><input type="hidden" name="ass_id" value="<?php echo $_POST['ass_id']; ?>" />        <input type="submit" value="Salvar Altera&ccedil;&otilde;es" /></td>
    </tr>
  </table>
