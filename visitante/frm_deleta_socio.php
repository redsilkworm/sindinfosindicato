...
if ((isset($_GET['socio'])) && ($_GET['socio'] != "")) {
  ...
  $deleteGoTo = "frm_cadastro_socios.php?associado=" . $row_rs_socio['ass_cnpj'] . "&nro_socios=" . $row_rs_socio['ass_nro_socios'] . "";
...
<body class="outra">
<span class="outra"><?php echo $row_rs_socio['soc_id']; ?></span> - <?php echo $row_rs_socio['soc_nome']; ?>
</body>
</html>
<?php
