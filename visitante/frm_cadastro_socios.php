...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $insertGoTo = "frm_cadastro_socios.php?associado=" . $row_rs_associado['ass_cnpj'] . "&nro_socios=" . $row_rs_associado['ass_nro_socios'] . "";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<p>&nbsp;</p>
<p class="letra"><?php #echo $_GET['nro_socios'];?></p>
<p class="letra"><?php #echo $_GET['associado'];?></p>
...
<?php if ($totalRows_rs_socios > 0) { // Show if recordset not empty ?>
  <p align="center" class="letra"><strong>Rela&ccedil;&atilde;o de S&oacute;cios Cadastrados</strong></p>
  <table width="100%" border="1">
    <tr>
      <td class="letra">Nome</td>
      <td class="letra">Telefone</td>
      <td class="letra">A&ccedil;&atilde;o</td>
    </tr>
    <?php do { ?>
      <tr>
        <td class="letra"><?php echo $row_rs_socios['soc_nome']; ?></td>
        <td class="letra"><?php echo $row_rs_socios['soc_telefone']; ?></td>
        <td><form id="form2" name="form2" method="post" action="frm_deleta_socio.php?socio=<?php echo $row_rs_socios['soc_id']; ?>">
          <label>
